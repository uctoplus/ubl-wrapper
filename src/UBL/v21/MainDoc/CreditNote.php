...
use Uctoplus\UblWrapper\UBL\v21\Common\AggregateComponents\CreditNoteLineType;
...
use Uctoplus\UblWrapper\UBL\v21\Common\BasicComponents\CreditNoteTypeCodeType;
 ...
 * @method CreditNoteTypeCodeType getCreditNoteTypeCode()
 * @method self setCreditNoteTypeCode(CreditNoteTypeCodeType|string $value)
 ...
 * @method CreditNoteLineType[] getCreditNoteLine()
 * @method self addCreditNoteLine(CreditNoteLineType $value)
 * @method self setCreditNoteLine(CreditNoteLineType ...$values)
 */
class CreditNote extends MainDoc
{
    protected $UBLVersionID = Version::VERSION_CODE;
    protected $xmlns = "urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2";
    ...
    protected $casts = [
        ...
        "cbc:CreditNoteTypeCode" => CreditNoteTypeCodeType::class,
        ...
        "cac:CreditNoteLine" => CreditNoteLineType::class . "[]",
    ];
